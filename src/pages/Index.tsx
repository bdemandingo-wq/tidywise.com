...
const Index = () => {
  return (
    <>
      <SEOSchema
        pageTitle="House Cleaning Deerfield Beach & South Florida | TIDYWISE"
        pageDescription="House cleaning in Deerfield Beach & South Florida. Licensed & insured, flat-rate quotes, eco-friendly products, free re-clean guarantee. Book in 60 seconds."
